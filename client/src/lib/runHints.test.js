...
describe('hintFor', () => {
   ...
   */
  /**
   * The advice describes the run, not the box. Judging by what the box holds
   * now means it vanishes the instant someone acts on it, leaving the failure
   * it was explaining on screen with nothing to explain it.
   */
  it('stays quiet when that run was given input', () => {
