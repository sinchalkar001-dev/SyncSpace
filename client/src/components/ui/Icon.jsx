...
const ICONS = {
  ...
  hand: {
    d: 'M8 11.5 V5.6 A1.6 1.6 0 0 1 11.2 5.6 V11 M11.2 11 V4.4 A1.6 1.6 0 0 1 14.4 4.4 V11 M14.4 11 V6 A1.6 1.6 0 0 1 17.6 6 V13.5 M17.6 9.5 A1.6 1.6 0 0 1 20.6 10.4 C20.6 16 18 20.5 13.6 20.5 C10 20.5 8.4 18.8 6.4 15.4 L4.6 12.3 A1.6 1.6 0 0 1 7.2 10.6 L8 11.8',
  },
  ...
  chevronUp: { d: 'M5 15 L12 8 L19 15' },
  unlock: { d: 'M7 11 V7.5 A5 5 0 0 1 16.5 6 M5 11 H19 V21 H5 Z' },
